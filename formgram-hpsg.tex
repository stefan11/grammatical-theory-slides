...
\pause
\item sign-based \citep{Saussure16a}
\pause
...
\pause
\item \argst as a underlying representation containing all arguments.
\pause
...
\frame{
\frametitle{Structure sharing of \head features}
...
\eal
\ex 
\gll \gruen{dass} [jeder diesen Mann \rot<2->{kennt}]\\
     that \spacebr{}everybody this man knows\\
\glt `that everybody knows this man'
\ex 
\gll \gruen{Kennt} [jeder diesen Mann \rot<3->{\_} ]\\
...
\frame{
\frametitle{Local reordering: Two options}
...
\eal
\ex 
\gll {}[weil] \gruen{jeder} \blau{diesen} \blau{Mann} kennt\\
	 {}\spacebr{}because everyone.\NOM{} this.\ACC{} man knows\\
\ex 
\gll {}[weil] \blau{diesen} \blau{Mann} \gruen{jeder} kennt\\
