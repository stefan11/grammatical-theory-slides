...
\pause
\item (Reasoning: Grammars are formed/limited by UG. We know that English has property X
\pause
\item In order to understand the particular analysis discussed here, we first have to look at English.
\end{itemize}
