...
%\usepackage{dgmacros,dalrymple} % Mary Dalrymples macros
...
% \exewidth{(145)}
\include{formgram-gb}
\include{formgram-gb2}
\exewidth{(235)}
\include{formgram-gb3}
\include{formgram-gpsg}
\include{formgram-feature-descriptions}
